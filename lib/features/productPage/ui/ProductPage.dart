      ...
      appBar: AppBar(
        ...
        actions: [
          CircleAvatar(
            ...
            child: IconButton(onPressed: () {
       !isSelect?  productBloc.add(FavoriteButtonClickedEvent(clickedProduct: widget.product)):
       productBloc.add(FavoriteButtonRemoveEvent(clickedProduct: widget.product));
              setState(() {
                isSelect = !isSelect;
              });
            },
              icon:  Icon(
               !isSelect?  Icons.favorite_outline: Icons.favorite,color: Colors.red,),),
          ),
          const SizedBox(
            width: 10,
          ),
